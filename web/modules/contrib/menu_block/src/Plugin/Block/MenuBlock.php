...
class MenuBlock extends SystemMenuBlock {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    // Remove core's "Expand all menu items" checkbox that was added in Drupal
    // 8.7 since this module already provides this functionality. It's easier
    // to hide core's checkbox than to adopt it and drop ours, since we don't
    // need to worry about a block config migration path.
    if (isset($form['menu_levels']['expand_all_items'])) {
