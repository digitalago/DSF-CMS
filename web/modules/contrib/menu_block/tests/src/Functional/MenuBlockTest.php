...
class MenuBlockTest extends BrowserTestBase {
  ...
  public function testMenuBlockFormDisplay() {
    ...
    // Core's checkbox for expanding menu links should be hidden. It uses
    // slightly different wording than ours.
    $this->assertSession()->pageTextNotContains('Expand all menu items');
  }
