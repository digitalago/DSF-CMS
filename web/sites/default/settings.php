 ...
 * @endcode
 */
$settings['hash_salt'] = 'i4RN7cafeA1R7J8e0aYYkMa-sP9aiu8ylR06nQOj0cA_70doXU6ge6ickZMIStsROjTmPHR8eg';
...
$config['environment_indicator.indicator']['name'] = getenv('PANTHEON_ENVIRONMENT');

if (getenv('PANTHEON_ENVIRONMENT') == 'dev') {
  $config['config_split.config_split.dev']['status'] = TRUE;
  $config['environment_indicator.indicator']['bg_color'] = '#009ED8';
}
else if (getenv('PANTHEON_ENVIRONMENT') == 'test') {
...
# When on Pantheon, connect to another database for migration purposes.
